# Урок 02. Основы работы командира по подготовке боя (част 1)
...
* оценка обстановки;
* принятие или выработка решения;
...
На этом уроке мы познакомимся с понятиями **«Уяснение полученной задачи»** и **«Оценка обстановки»**
...
* какой противник находится перед подразделением и вероятный характер его действий;
